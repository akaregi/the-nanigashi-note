...
type BlogPageQuery = { readonly microcmsBlogs: { readonly blogsId: string | null, readonly title: string | null, readonly content: string | null, readonly publishedAt: string | null } | null };
...
type CreatePagesQuery = { readonly allMicrocmsBlogs: { readonly edges: ReadonlyArray<{ readonly node: { readonly blogsId: string | null }, readonly next: { readonly blogsId: string | null, readonly title: string | null } | null, readonly previous: { readonly blogsId: string | null, readonly title: string | null } | null }> } };
